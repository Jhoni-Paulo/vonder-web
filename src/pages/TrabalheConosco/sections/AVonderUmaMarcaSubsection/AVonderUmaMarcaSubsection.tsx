...
export const AVonderUmaMarcaSubsection = (): React.JSX.Element => {
  return (
    <Container>
      <TextWrapper2>A </TextWrapper2>
      <TextWrapper3>VONDER</TextWrapper3>
      <TextWrapper2>
        {" "}
      ...
      <TextWrapper3>Grupo OVD</TextWrapper3>
      <TextWrapper2>
        ...
        oferecer mais do que apenas produtos: proporcionamos soluções que fazem
        a diferença no dia a dia de nossos clientes, sempre buscando superar
        suas expectativas.
        <br />
        <br />
